    ...
    return (
        <div className="min-h-screen bg-gradient-to-tl from-black via-black to-black/90 text-white selection:bg-yellow-500/30">
            <div className="max-w-[1500px] mx-auto px-6 py-20">
                ...
                {/* --- HERO / CTA SECTION --- */}
                <div className="hidden sm:block relative w-full h-[400px] md:h-[500px] rounded-l-3xl  border border-black/70 bg-gradient-to-tl from-black via-black to-black/70  overflow-hidden flex flex-col justify-center px-8 md:px-16 mb-20">
